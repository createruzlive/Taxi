@echo off
REM ============================================================
REM  ishga_tushir_hodim.bat
REM  chaqiruv.py ni "Hodim" rejimida FONDA ishga tushiradi.
